---
title: "Multimodal ONA Model for Dr. Shamya"
output:
  html_document:
    df_print: paged
editor_options: 
...
code_cols <- c(
  "Moving", "Stopping", "Talking", "Monitoring", "Incorrect_attempt", "Correct_attempt", "Raising_hand", "Hint_request", "Gaming_State", "Misuse_State", "Idle_State", "Inactive", "Questioning", "Struggle_State"
)
...
```{r}
# # TODO: Decide on something to regress against 
# ona_multimodal_tif_SVD <- lm(ona_multimodal_tif_set$points$SVD1 ~ ona_multimodal_tif_set$points$) %>% summary()
# ona_multimodal_tif_SVD$r.squared
```

## 3. Interpretive alignment
```{r}
source("~/Desktop/epistemic_analytics/shamya_collab/shamya_collab/code/ona_plotter_shamya.R")
make.ona.plot(ona_multimodal_tif_set, 
              "Shamya Multimodal Model")
```
